...
Config.Delays = {
	...
	MethProcessing = 3000 * 10,
	CokeProcessing = 1500 * 10,
...
Config.CircleZones = {
	...
	WeedProcessing = {coords = vector3(1408.26, 3668.19, 34.01), blimpcoords = vector3(1408.26, 3668.19, 34.01), name = _U('blip_weedprocessing'), color = 25, sprite = 496, radius = 0.0, enabled = true},
	
	--meth
	MethProcessing = {coords = vector3(891.11, -961.25, 39.28), blimpcoords = vector3(891.11, -961.25, 39.28), name = _U('blip_methprocessing'), color = 5, sprite = 51, radius = 0.0, enabled = true},
	...
	CokeProcessing = {coords = vector3(1979.36, -2610.82, 3.55), blimpcoords = vector3(1979.36, -2610.82, 3.55), name = _U('blip_Cokeprocessing'),color = 4, sprite = 501, radius = 0.0, enabled = true},
	...
	HeroinProcessing = {coords = vector3(161.41, 3131.96, 43.56), blimpcoords = vector3(161.41, 3131.96, 43.56), name = _U('blip_heroinprocessing'), color = 7, sprite = 497, radius = 0.0, enabled = true},
